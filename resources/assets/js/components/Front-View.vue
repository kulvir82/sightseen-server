      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto">
            ...
            <div class="badges">
              <a class="badge-link" href="#"><img src="{{asset("images/frontimages/google-play-badge.svg")}}" alt=""></a>
              <a class="badge-link" href="#"><img src="{{asset("images/frontimages/app-store-badge.svg")}}" alt=""></a>
            </div>
          </div>
        </div>
      </div>
